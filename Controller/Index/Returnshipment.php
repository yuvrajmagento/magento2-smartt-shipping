...
class Returnshipment extends \Magento\Framework\App\Action\Action
{
    /**
    ...
    public function execute()
    {
        ...
        try {
            ...
            $this->messageManager->addError(__('Error appeared while save data for inbound dispatch. ').$e->getMessage());
        }
